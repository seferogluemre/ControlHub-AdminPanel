      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-muted-foreground text-sm">Kime:</span>
          ...
          <Command className="rounded-lg border">
            <CommandInput placeholder="Kişi ara..." className="text-foreground" />
            <CommandList>
              <CommandEmpty>Kimse bulunamadı.</CommandEmpty>
              <CommandGroup>
                {users.map((user) => (
                  <CommandItem
                    key={user.id}
