...
const AuthenticatedPanelChatsIndexRoute = AuthenticatedPanelChatsIndexRouteImport.update({
  id: "/chats/",
  path: "/chats/",
  getParentRoute: () => AuthenticatedPanelRouteRoute,
} as any);
...
const AuthenticatedPanelAgentsIndexRoute = AuthenticatedPanelAgentsIndexRouteImport.update({
  id: "/agents/",
  path: "/agents/",
  getParentRoute: () => AuthenticatedPanelRouteRoute,
} as any);
